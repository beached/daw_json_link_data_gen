...
namespace daw::json {
	...
	struct json_data_contract<daw::citm::events_value_t> {
		...
		using type =
		  json_member_list<json_link<id, std::int64_t>,
		                   json_string_raw_null<logo, std::string>,
		                   json_link<name, std::string>,
	...
	struct json_data_contract<daw::citm::performances_element_t> {
		...
		using type = json_member_list<
		  ...
		  json_link<start, std::int64_t>, json_link<venueCode, std::string>>;
	...
	struct json_data_contract<daw::citm::venueNames_t> {
		...
		using type = json_member_list<json_string_raw<PLEYEL_PLEYEL, std::string>>;
	...
	struct json_data_contract<daw::citm::citm_object_t> {
		...
		using type = json_member_list<
		  json_key_value<areaNames, std::unordered_map<std::int64_t, std::string>,
		                 std::string,
		                 json_number_no_name<
		                   std::int64_t, options::number_opt(
		                                   options::LiteralAsStringOpt::Always )>>,
		  json_key_value<audienceSubCategoryNames,
		                 std::unordered_map<std::int64_t, std::string>, std::string,
		                 json_number_no_name<
		                   std::int64_t, options::number_opt(
		                                   options::LiteralAsStringOpt::Always )>>,
		  json_key_value<
		  ...
		  json_key_value<topicSubTopics,
		                 ...
		                 std::vector<std::int64_t>, std::string>,
